...
var eng = new Engine("#render", standartPostProces, 0.15, 4096);
...
function main(){
    ...
    var pawn = new Mesh(pawnv, pawnn, pawnu, standartFragmentShaderNoShadowMaping, standartVertexShader, eng, m, s, n, mx, my, false, cubem);
